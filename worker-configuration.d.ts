/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2a3cc6b7c13125d4ed654edfb1690d74)
// Runtime types generated with workerd@1.20251001.0 2025-10-06 
declare namespace Cloudflare {
	interface Env {
		NUXT_SESSION_PASSWORD: string;
		NUXT_OAUTH_AUTH0_CLIENT_SECRET: string;
		NUXT_OAUTH_AUTH0_CLIENT_ID: string;
		DB: D1Database;
	}
}
